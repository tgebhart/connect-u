angular.module("app").controller('StudentViewJobController', function($scope, $timeout, $cookies, $http, $location, AuthenticationService, $log, $templateCache, JobResource) {
