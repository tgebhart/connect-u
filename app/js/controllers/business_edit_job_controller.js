  angular.module("app").controller('BusinessEditJobController', function($scope, $timeout, $cookies, $http, $location, AuthenticationService, $log, $templateCache, BusinessUserService, JobService, moment, JobResource) {
